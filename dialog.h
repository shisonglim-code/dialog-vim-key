/*
 *  $Id: dialog.h,v 1.313 2026/01/02 11:28:17 tom Exp $
 *
...
#define PROMPT_ROWS  1	/* rows to allow for subtitle/caption/prompt */
#define BUTTON_ROWS  1	/* rows to allow for buttons */
